...
- `tau` = relaxation timescale, ~30 simulation days = `30 * 86400 = 2,592,000 seconds`
...
|----------|-------|-------|---------|
| `RELAXATION_TIMESCALE` | `2_592_000` | seconds (30 days) | Newtonian relaxation timescale |
...
The 30-day relaxation timescale is a starting point. If heat transport patterns are too subtle,
increase `tau`. If temperature drifts unrealistically, decrease `tau`. Findings will be recorded
